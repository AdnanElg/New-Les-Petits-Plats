/**
 * Liste de recettes sous forme d'un tableau d'objets JavaScript.
 * Chaque objet représente une recette avec les propriétés suivantes :
 * - id: identifiant unique de la recette (number)
 * - name: nom de la recette (string)
 * - servings: nombre de personnes pour lesquelles la recette est prévue (number)
 * - ingredients: liste des ingrédients nécessaires pour réaliser la recette (tableau d'objets).
 *                Chaque objet représente un ingrédient avec les propriétés suivantes :
 *                - ingredient: nom de l'ingrédient (string)
 *                - quantity: quantité nécessaire (number)
 *                - unit: unité de mesure (string, facultatif)
 * - time: temps de préparation en minutes (number)
 * - description: description de la recette (string)
 * - appliance: nom de l'appareil nécessaire pour réaliser la recette (string)
 * - ustensils: liste des ustensiles nécessaires pour réaliser la recette (tableau de strings)
 * - image : liste des image nécessaires pour les recette (string)
 */
